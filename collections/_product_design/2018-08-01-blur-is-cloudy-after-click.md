...
![The Stage is on the Rise]({{ site.cdn_url | append: "/assets/images/04-blur-is-cloudy-after-click/02.jpg" }} "막이 올라가고,"){: loading='lazy'}
{: .normal-size}
...
![Pro, Apple.]({{ site.cdn_url | append: "/assets/images/04-blur-is-cloudy-after-click/03.jpg" }} "어느 순간부터 애플과 신출내기는 어울리지 않는 조합이 되었다"){: loading='lazy'}
{: .normal-size}
...
![Rookie, Microsoft.]({{ site.cdn_url | append: "/assets/images/04-blur-is-cloudy-after-click/04.jpg" }} "마이크로소프트의 UX 개발은 완성을 향해 다가가고 있다"){: loading='lazy'}
{: .normal-size}
...
![Second Best, Blur.]({{ site.cdn_url | append: "/assets/images/04-blur-is-cloudy-after-click/05.jpg" }} "결국 블러는 차선책"){: loading='lazy'}
{: .normal-size}
...
![Do not close]({{ site.cdn_url | append: "/assets/images/04-blur-is-cloudy-after-click/06.jpg" }} "자세히 보지 않아도"){: loading='lazy'}
{: .normal-size}
