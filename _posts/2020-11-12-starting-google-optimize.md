...
![Google Optimize]({{ site.cdn_url | append: '/assets/images/design/starting-google-optimize/02.jpg' }} "구글 옵티마이즈")
{: .full-size}
...
![My Container Page]({{ site.cdn_url | append: '/assets/images/design/starting-google-optimize/03.jpg' }} "내 컨테이너 페이지")

구글 옵티마이즈 웹사이트에서 시작하기를 누르면 몇 가지 절차를 거친 후에 ‘내 컨테이너’ 페이지로 이동하게 됩니다. 앞으로 AB 테스트를 시작할 때 제일 먼저 찾는 곳이 될 겁니다.

![Setting for Install Optimize]({{ site.cdn_url | append: '/assets/images/design/starting-google-optimize/04.jpg' }} "옵티마이즈 설치를 위한 설정 페이지")
...
![Analytics Integration]({{ site.cdn_url | append: '/assets/images/design/starting-google-optimize/05.jpg' }} "애널리틱스 연동")
...
![AB Test Option Page]({{ site.cdn_url | append: '/assets/images/design/starting-google-optimize/06.jpg' }} "테스트 옵션 화면")
...
![AB Test Setting Page]({{ site.cdn_url | append: '/assets/images/design/starting-google-optimize/07.jpg' }} "AB 테스트 구성 화면")
...
![Checking Installation]({{ site.cdn_url | append: '/assets/images/design/starting-google-optimize/08.jpg' }} "옵티마이즈 설치 확인")
...
![Editing Variation]({{ site.cdn_url | append: '/assets/images/design/starting-google-optimize/09.jpg' }} "대안 수정")
...
![Setting Metrics]({{ site.cdn_url | append: '/assets/images/design/starting-google-optimize/10.jpg' }} "측정 지표 설정")
...
![Analytics Metrics]({{ site.cdn_url | append: '/assets/images/design/starting-google-optimize/11.jpg' }} "애널리틱스 목표")
...
![Active Event]({{ site.cdn_url | append: '/assets/images/design/starting-google-optimize/12.jpg' }} "활성화 이벤트")
