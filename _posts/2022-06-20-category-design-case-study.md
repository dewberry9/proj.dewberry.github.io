...
카테고리의 수직적 확장은 고객이 원하는 조건을 더 많이 반영할 수 있지만 그만큼 복잡성이 증가한다는 측면에서 한계가 있습니다. 이때 제품은 고객이 자신의 니즈를 선택적으로 적용할 수 있는 길을 열어 놓습니다. 검색과 필터가 바로 그 길입니다. 우선 카테고리로 큰 줄기를 정하고, 검색과 필터링으로 세밀한 조건을 반영하는 것입니다.
