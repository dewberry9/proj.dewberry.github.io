---
title: 전략을 결정하는 전략. 제품 전략 수립·평가 방법론 DHM 모델
layout: post
...
시리즈로 구성된 글입니다. 이번 글에서는 DHM 모델의 개념과 구성에 대해, 다음 편에서는 DHM 모델로 수립된 제품 전략이 실무적으로 구체화되는 과정을 알아봅니다.
{: .infor}
...
이번 편에서는 제품 전략을 수립하는 전략인 DHM의 개념과 구성, 즉 고객 만족, 복제의 어려움, 수익성에 대해 실제 제품 사례와 함께 알아보았습니다.
이어지는 글에서는 DHM 모델로 수립된 제품 전략이 어떤 과정을 통해 실무 단계까지 내려와 작동하는지 살펴보겠습니다.
