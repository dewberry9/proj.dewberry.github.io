...
![G]({{ '/assets/images/12-next-step-the-cozy/01.jpg' | relative_url }} "번쩍이는 작은 박스를 손에 든 원숭이, 현대인")
...
![G]({{ '/assets/images/12-next-step-the-cozy/02.jpg' | relative_url }} "정적 속에서 기름이 끓는 소리마저 소비되는 세상")
...
![G]({{ '/assets/images/12-next-step-the-cozy/03.jpg' | relative_url }} "선정리가 필요한 순간")
...
![G]({{ '/assets/images/12-next-step-the-cozy/04.jpg' | relative_url }} "지치는 디자인")
...
![G]({{ '/assets/images/12-next-step-the-cozy/05.jpg' | relative_url }} "편-안")
...
![G]({{ '/assets/images/12-next-step-the-cozy/06.jpg' | relative_url }} "다음")
