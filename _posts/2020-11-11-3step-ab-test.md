...
![AB Test in Many Apps]({{ site.cdn_url | append: '/assets/images/design/3step-ab-test/02.jpg' }} "이미 많은 기업에서 활용 중인 AB 테스트")
{: .full-size}
...
![AB Test Cycle]({{ site.cdn_url | append: '/assets/images/design/3step-ab-test/03.jpg' }} "AB 테스트 사이클")
{: .normal-size}
...
![Structure of the AB test hypothesis]({{ site.cdn_url | append: '/assets/images/design/3step-ab-test/04.jpg' }} "AB 테스트 가설의 구조")
{: .normal-size}
...
가설 수립 단계에서 AB 테스트에 대한 리포트 역시 준비하게 되는데 [이런 형태의 노션(Notion) 템플릿](https://www.notion.so/dewberry9/AB-bd3ad2cfce654938b50e4e04f915c0c7 "AB Test Templete on Notion")으로 미리 만들어놓고는 합니다. (복제해서 활용하세요!) 템플릿에 맞춰서 AB 테스트를 준비하면 불완전했던 가설과 계획의 구조를 다듬을 수 있습니다.
...
![Notes for when traffic diverges]({{ site.cdn_url | append: '/assets/images/design/3step-ab-test/05.jpg' }} "분기 시 주의점")
{: .normal-size}
...
![AB Test Calculator]({{ site.cdn_url | append: '/assets/images/design/3step-ab-test/06.jpg' }} "AB 테스트 계산기")
{: .normal-size}
