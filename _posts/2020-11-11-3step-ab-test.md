...
![AB Test Cycle]({{ '/assets/images/design/3step-ab-test/03.jpg' | relative_url }} "AB 테스트 사이클")
...
![Structure of the AB test hypothesis]({{ '/assets/images/design/3step-ab-test/04.jpg' | relative_url }} "AB 테스트 가설의 구조")
...
![Notes for when traffic diverges]({{ '/assets/images/design/3step-ab-test/05.jpg' | relative_url }} "분기 시 주의점")
...
![AB Test Calculator]({{ '/assets/images/design/3step-ab-test/06.jpg' | relative_url }} "AB 테스트 계산기")
