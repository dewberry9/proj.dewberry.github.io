...
가설 수립 단계에서 AB 테스트에 대한 리포트 역시 준비하게 되는데 [이런 형태의 노션(Notion) 템플릿](https://www.notion.so/dewberry9/AB-bd3ad2cfce654938b50e4e04f915c0c7 "AB Test Templete on Notion")으로 미리 만들어놓고는 합니다. (미리 복제해두세요!) 이 템플릿은 가이드 2부에서 실제로 AB 테스트를 진행할 때 함께 작성해보겠습니다.
